          ...
          <transition-group name="flip-list"  class="list-group">
            <div class="column_master" v-for="col in board.boardColumns" :key="col.id">
              ...
              <div class="column" :data-id="col.id">
                <vue-draggable v-model="col.cards"  :options="{group:'cards'}" @change="onEndMoveCard(col, $event)" element="div">
                  <transition-group name="flip-list"  class="list-group">
                    <div class="portlet"
                      ...
                      <div class="portlet-content">
                        <div v-on:click.stop="cardShow(card.id)">
                          <span class='name'>
                            {{card.name}}
                            <span class="contacnt-name" v-if="card.mainContact"> - {{card.mainContact.name}}</span>
                          </span>
                        </div>
                        <div></div>
